...
def get_3hop_neighbors_with_distances(graph, root_node, hop=3):
    """
    Memory-efficient implementation of finding n-hop neighbors using BFS
    """
    distances = {}
    ...
    for distance in range(1, hop + 1):
        ...
        if not current_level:  # If no more neighbors, break early
            break
            
    return list(distances.keys()), distances
